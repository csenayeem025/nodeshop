            ...
            <div class="tg-container">
                ...
                <div id="primary" class="content-area">
                    <main id="main" class="site-main" role="main">
                        ...
                        <div id="pl-474" class="panel-layout">
                            <div class="panel-grid panel-has-style clearfix" style="background:#f9f9f9;">
                    ...
                    <router-view></router-view>
                          ...
                          <!--newsleatter start-->
                          <section class="">
                            <div class="newsletter newsletter-inverse">
...
import MobileCart from '@/components/layouts/mobilecart'
...
export default {
  ...
  components:{
  	sidebar,cart,cfooter,MobileCart,modal,login,InfiniteLoading,product
  },
  watch:{
  ...
  methods:{
      ...
      getHomeSpecials(){
  		var self = this
  		axios.get(this.$host+'home/specials')
  		.then(response=>{
        if(response.data.length){
            self.specials = response.data
        }else{
            self.specials = []
        }
  		})
  	...
  	isChangeCart(){
  		this.$store.dispatch('setDance',false)
