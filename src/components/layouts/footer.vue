<template>
           ...
           <div class="row">
             <div class="col-md-12">
               <div class="footer-logo">
                 <a href="/"> <img src="static/assets/uploads/sites/flash-logo.png" class="img-fluid  " width="150px" alt="logo"></a>
               </div>
                     ...
                     <div class="row">
                       <div class="app-link-bloc-contain p-0">
                         <div class="app-item-group">
                           <div class="app-item">
                             <img src="static/themes/assets/images/layout-1/app/1.png" class="img-fluid" alt="app-banner">
                           </div>
                           <div class="app-item">
                             <img src="static/themes/assets/images/layout-1/app/2.png" class="img-fluid" alt="app-banner">
                           </div>
                         </div>
                         <div class="app-item-group ">
                           <div class="sosiyal-block" >
                             <h6>follow us</h6>
                             <ul class="sosiyal">
                               <li><a target="_blank" href="https://www.facebook.com/csenayeem025"><i class="fa fa-facebook" ></i></a></li>
                               <li><a target="_blank" href="https://twitter.com/csenayeem025"><i class="fa fa-twitter" ></i></a></li>
                               <li><a target="_blank" href="https://www.instagram.com/csenayeem025/"><i class="fa fa-instagram" ></i></a></li>
                               <li><a target="_blank" href="https://www.linkedin.com/in/csenayeem025"><i class="fa fa-rss" ></i></a></li>
                             </ul>
                           </div>
                         </div>
                       </div>
             ...
             <div class="row">
               ...
               <div class="col-xl-6 col-md-4 col-sm-12">
                 <div class="payment-card-bottom">
                   <ul>
                     <li><a href="#"><img src="static/themes/assets/images/layout-1/pay/1.png" class="img-fluid" alt="pay"></a></li>
                     <li><a href="#"><img src="static/themes/assets/images/layout-1/pay/2.png" class="img-fluid" alt="pay"></a></li>
                     <li><a href="#"><img src="static/themes/assets/images/layout-1/pay/3.png" class="img-fluid" alt="pay"></a></li>
                     <li><a href="#"><img src="static/themes/assets/images/layout-1/pay/4.png" class="img-fluid" alt="pay"></a></li>
                     <li><a href="#"><img src="static/themes/assets/images/layout-1/pay/5.png" class="img-fluid" alt="pay"></a></li>
                   </ul>
                 </div>
               </div>
             </div>
         ...
         <div class="cart_media">
           <ul class="cart_product">
             <li>
               <div class="media">
                 <a href="#">
                   <img alt="" class="mr-3" src="static/themes/assets/images/layout-4/product/1.jpg">
                 </a>
             ...
             <li>
               <div class="media">
                 <a href="#">
                   <img alt="" class="mr-3" src="static/themes/assets/images/layout-4/product/2.jpg">
                 </a>
                 <div class="media-body">
                   <a href="#">
                     <h4>item name</h4>
             ...
             <li>
               <div class="media">
                 <a href="#"><img alt="" class="mr-3" src="static/themes/assets/images/layout-4/product/3.jpg"></a>
                 <div class="media-body">
                   <a href="#">
                     <h4>item name</h4>
                   </a>
           ...
           <div class="modal-body">
             ...
             <div class="row">
               <div class="col-lg-6 col-xs-12">
                 <div class="quick-view-img"><img src="static/themes/assets/images/layout-4/product/3.jpg" alt="quick" class="img-fluid "></div>
               </div>
         ...
         <div class="cart_media">
           <ul class="cart_product">
             <li>
               <div class="media">
                 <a href="#">
                   <img alt="" class="mr-3" src="static/themes/assets/images/layout-1/media-banner/1.jpg">
                 </a>
                 <div class="media-body">
                   <a href="#">
                     <h4>item name</h4>
             ...
             <li>
               <div class="media">
                 <a href="#">
                   <img alt="" class="mr-3" src="static/themes/assets/images/layout-1/media-banner/2.jpg">
                 </a>
                 <div class="media-body">
                   <a href="#">
                     <h4>item name</h4>
             ...
             <li>
               <div class="media">
                 <a href="#"><img alt="" class="mr-3" src="static/themes/assets/images/layout-1/media-banner/3.jpg"></a>
                 <div class="media-body">
     ...
     <div class="product-notification" id="dismiss">
       ...
       <div class="media">
         <img class="mr-2" src="static/themes/assets/images/layout-1/product/5.jpg" alt="Generic placeholder image">
         <div class="media-body">
