<template>
    <keep-alive>
	<div class="products" style="background:#f9f9f9;">
                ...
                <div class="slider-banner slide-banner-3">
                  <div class="slider-img">
                    <ul class="layout4-slide-1">
                      <li id="img-1"><img src="static/assets/uploads/sites/slider-1.jpg" class="img-fluid" alt="slider"></li>
                    </ul>
                  </div>
                ...
                <div class="slider-banner slide-banner-3">
                  <div class="slider-img">
                    <ul class="layout4-slide-2">
                      <li id="img-2"><img src="static/assets/uploads/sites/slider-2.jpg" class="img-fluid" alt="slider"></li>
                    </ul>
                  </div>
<!--                  <div class="slider-banner-contain">-->
<!--                    <div>-->
                ...
                <div class="slider-banner slide-banner-3">
                  <div class="slider-img">
                    <ul class="layout4-slide-3 ">
                      <li id="img-3" class="slide-center"><img src="static/assets/uploads/sites/slider-3.jpg" class="img-fluid" alt="slider"></li>
                    </ul>
                  </div>
<!--                  <div class="slider-banner-contain">-->
<!--                    <div>-->
...
<!--        >-->
<!--          <slide>-->
<!--            <img src="static/assets/uploads/sites/slider-1.jpg" alt="Awesome nGrocery" title="Awesome nGrocery" />-->
<!--          </slide>-->
<!--          <slide>-->
<!--            <img src="static/assets/uploads/sites/slider-2.jpg" alt="Awesome nGrocery" title="Awesome nGrocery" />-->
<!--          </slide>-->
<!--          <slide>-->
<!--            <img src="static/assets/uploads/sites/slider-3.jpg" alt="Awesome nGrocery" title="Awesome nGrocery" />-->
<!--          </slide>-->
<!--          <slide>-->
<!--            <img src="static/assets/uploads/sites/slider-1.jpg" alt="Awesome nGrocery" title="Awesome nGrocery" />-->
<!--          </slide>-->
...
<!--        </carousel>-->
    ...
    <section class="collection-banner ">
      <div class="custom-container">
        <div class="row layout-4-collection">
          <div class="col-md-4  ">
            <div class="collection-banner-main p-left  height-equal">
              <div class="collection-img">
                <img src="static/themes/assets/images/layout-4/collection-banner/1.jpg" class="img-fluid bg-img  " alt="banner">
              </div>
          ...
          <div class="col-md-4  ">
            <div class="collection-banner-main p-left  height-equal">
              <div class="collection-img ">
                <img src="static/themes/assets/images/layout-1/collection-banner/2.jpg" class="img-fluid bg-img  " alt="banner">
              </div>
              <div class="collection-banner-contain">
                <div>
                  <h3>hand</h3>
          ...
          <div class="col-md-2 ">
            <div class="collection-banner-main p-left banner-8 height-equal">
              <div class="collection-banner-contain">
                <div>
                  <h3>extra</h3>
                  <h3>50% off</h3>
  ...
  <div class="columns" style="margin-top: 20px;">
    ...
    <div class="columns is-mobile out-of-the-box" style="margin-top: 20px;margin-bottom:20px;">
      <div class="column">
        ...
        :loop="true"
        :perPageCustom="[[0,1], [768,3], [1024,4]]"
        >
          <slide v-for="(product,index) in top" :key="index">
              <div class="product">
                <div class="product-image">
                  <figure class="is-product">
                    <img :src="$first(product.image).link" alt="">
                  </figure>
                </div>
                <div class="product-body has-text-centered">
                  <div style="min-height: 140px;">
                    <p class="is-size-6">{{product.title}}</p>
                    <p>{{product.net}} {{product.unit}}</p><br>
                    ...
                    <br><br>
                      <nav class="level" v-if="!showbutton">
                        <div class="level-item">
                          <span class="fa fa-minus-circle fa-2x"></span>
                        </div>
                        <div class="level-item">
                          <span class="count fa-2x">0</span>
                        </div>
                        <div class="level-item">
                          <span class="fa fa-plus-circle fa-2x" ></span>
                        </div>
                      </nav>
                      <button class="button is-warning" @click.prevent="setCart(product)" v-else>Add to bag</button>
                  ...
                  <div class="product-slide-6 product-m no-arrow">
                      ...
                      <div class="product-box">
                        <div class="product-imgbox">
                          <div class="product-front">
                            <img src="static/themes/assets/images/layout-4/product/1.jpg" class="img-fluid  " alt="product">
                          </div>
                          <div class="product-back">
                            <img src="static/themes/assets/images/layout-4/product/a1.jpg" class="img-fluid  " alt="product">
                          </div>
                    ...
                    <div>
                      <div class="product-box">
                        <div class="product-imgbox">
                          <div class="product-front">
                            <img src="static/themes/assets/images/layout-4/product/2.jpg" class="img-fluid  " alt="product">
                          </div>
                          <div class="product-back">
                            <img src="static/themes/assets/images/layout-4/product/a2.jpg" class="img-fluid  " alt="product">
                          </div>
                        </div>
                    ...
                    <div>
                      <div class="product-box">
                        <div class="product-imgbox">
                          <div class="product-front">
                            <img src="static/themes/assets/images/layout-4/product/3.jpg" class="img-fluid  " alt="product">
                          </div>
                          <div class="product-back">
                            <img src="static/themes/assets/images/layout-4/product/a3.jpg" class="img-fluid  " alt="product">
                          </div>
                          <div class="new-label3">
                            <div>new</div>
                          </div>
                    ...
                    <div>
                      <div class="product-box">
                        <div class="product-imgbox">
                          <div class="product-front">
                            <img src="static/themes/assets/images/layout-4/product/4.jpg" class="img-fluid  " alt="product">
                          </div>
                          <div class="product-back">
                            <img src="static/themes/assets/images/layout-4/product/a4.jpg" class="img-fluid  " alt="product">
                          </div>
                        </div>
                        <div class="product-detail detail-center ">
                          <div class="detail-title">
                    ...
                    <div>
                      <div class="product-box">
                        <div class="product-imgbox">
                          <div class="product-front">
                            <img src="static/themes/assets/images/layout-4/product/5.jpg" class="img-fluid  " alt="product">
                          </div>
                          <div class="product-back">
                            <img src="static/themes/assets/images/layout-4/product/a5.jpg" class="img-fluid  " alt="product">
                          </div>
                          <div class="new-label3">
                            <div>new</div>
                          </div>
                    ...
                    <div>
                      <div class="product-box">
                        <div class="product-imgbox">
                          <div class="product-front">
                            <img src="static/themes/assets/images/layout-4/product/6.jpg" class="img-fluid  " alt="product">
                          </div>
                          <div class="product-back">
                            <img src="static/themes/assets/images/layout-4/product/a5.jpg" class="img-fluid  " alt="product">
                          </div>
                    ...
                    <div>
                      <div class="product-box">
                        <div class="product-imgbox">
                          <div class="product-front">
                            <img src="static/themes/assets/images/layout-4/product/7.jpg" class="img-fluid  " alt="product">
                          </div>
                          <div class="product-back">
                            <img src="static/themes/assets/images/layout-4/product/a7.jpg" class="img-fluid  " alt="product">
                          </div>
                        </div>
                        <div class="product-detail detail-center ">
                          <div class="detail-title">
                    ...
                    <div>
                      <div class="product-box">
                        <div class="product-imgbox">
                          <div class="product-front">
                            <img src="static/themes/assets/images/layout-4/product/8.jpg" class="img-fluid  " alt="product">
                          </div>
                          <div class="product-back">
                            <img src="static/themes/assets/images/layout-4/product/a8.jpg" class="img-fluid  " alt="product">
                          </div>
                        </div>
                        <div class="product-detail detail-center ">
                          <div class="detail-title">
...
<g>
        ...
        <div class="row collection2">
          <div class="col-md-4">
            <div class="collection-banner-main banner-1">
              <div class="collection-img">
                <img src="static/themes/assets/images/layout-4/collection-banner/3.jpg" class="img-fluid bg-img  " alt="banner">
              </div>
              <div class="collection-banner-contain">
                <div>
                  <h3>wooden</h3>
          ...
          <div class="col-md-4">
            <div class="collection-banner-main banner-1">
              <div class="collection-img">
                <img src="static/themes/assets/images/layout-4/collection-banner/4.jpg" class="img-fluid bg-img  " alt="banner">
              </div>
              <div class="collection-banner-contain ">
                <div>
                  <h3>canon</h3>
          ...
          <div class="col-md-4">
            <div class="collection-banner-main banner-1">
              <div class="collection-img">
                <img src="static/themes/assets/images/layout-4/collection-banner/5.jpg" class="img-fluid bg-img  " alt="banner">
              </div>
              <div class="collection-banner-contain ">
                <div>
                  <h3>women</h3>
                  ...
                  <div class="slide-5 no-arrow">
                    <div>
                      <div class="media-banner b-g-white1 border-0">
                        <div class="media-banner-box">
                          <div class="media">
                            <img src="static/themes/assets/images/layout-1/media-banner/1.jpg" class="img-fluid  " alt="banner">
                            <div class="media-body">
                        ...
                        <div class="media-banner-box">
                          <div class="media">
                            <img src="static/themes/assets/images/layout-1/media-banner/2.jpg" class="img-fluid  " alt="banner">
                            <div class="media-body">
                              <div class="media-contant">
                                <div>
                                  <div class="rating">
                        ...
                        <div class="media-banner-box">
                          <div class="media">
                            <img src="static/themes/assets/images/layout-1/media-banner/3.jpg" class="img-fluid  " alt="banner">
                            <div class="media-body">
                              <div class="media-contant">
                                <div>
                                  <div class="rating">
                    ...
                    <div>
                      <div class="media-banner b-g-white1 border-0">
                        <div class="media-banner-box">
                          <div class="media">
                            <img src="static/themes/assets/images/layout-1/media-banner/4.jpg" class="img-fluid  " alt="banner">
                            <div class="media-body">
                              <div class="media-contant">
                                <div>
                                  <div class="rating">
    ...
    <!--box categroy start-->
    <section class="box-category section-pb-space">
      ...
      <div class="custom-container ">
        <div class="row hot-4">
          <div class="col-md-2 pr-lg-0  ">
            <div class="media-banner b-g-white1 border-0 media-banner-2">
              <div class="media-banner-box">
          ...
          <div class="col-md-8 ">
            <div class="hot-deal layout-4">
              <div class="title1 pb-0 text-left pl-5">
                <h4>today's hot deal</h4>
              </div>
              <div class="slide-1 no-arrow">
                <div>
                  <div class="hot-deal-contain  deal-abjust b-g-white1 hot-deal-contain2">
                    <div class="row hot-deal-subcontain">
                      <div class="col-lg-4 col-md-4">
                        <div class="hotdeal-right-slick">
                          <div><img src="static/themes/assets/images/layout-2/hot-deal/8.jpg" alt="hot-deal" class="img-fluid  "></div>
                          <div><img src="static/themes/assets/images/layout-2/hot-deal/5.jpg" alt="hot-deal" class="img-fluid  "></div>
                          <div><img src="static/themes/assets/images/layout-2/hot-deal/7.jpg" alt="hot-deal" class="img-fluid  "></div>
                          <div><img src="static/themes/assets/images/layout-2/hot-deal/4.jpg" alt="hot-deal" class="img-fluid  "></div>
                        </div>
                      </div>
                    ...
                    <div class="row hot-deal-subcontain">
                      <div class="col-lg-4 col-md-4">
                        <div class="hotdeal-right-slick">
                          <div><img src="static/themes/assets/images/layout-2/hot-deal/7.jpg" alt="hot-deal" class="img-fluid  "></div>
                          <div><img src="static/themes/assets/images/layout-2/hot-deal/4.jpg" alt="hot-deal" class="img-fluid  "></div>
                          <div><img src="static/themes/assets/images/layout-2/hot-deal/2.jpg" alt="hot-deal" class="img-fluid  "></div>
                          <div><img src="static/themes/assets/images/layout-2/hot-deal/8.jpg" alt="hot-deal" class="img-fluid  "></div>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6">
            ...
            <div class="slide-1 no-arrow">
                ...
                <div class="testimonial-contain">
                  <div class="media">
                    <div class="testimonial-img">
                      <img src="static/themes/assets/images/testimonial/1.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                    </div>
                    <div class="media-body">
                      <h5>mark jecno</h5>
              ...
              <div>
                <div class="testimonial-contain">
                  <div class="media">
                    <div class="testimonial-img">
                      <img src="static/themes/assets/images/testimonial/2.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                    </div>
                    <div class="media-body">
                      <h5>mark jecno</h5>
                      <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
              ...
              <div>
                <div class="testimonial-contain">
                  <div class="media">
                    <div class="testimonial-img">
                      <img src="static/themes/assets/images/testimonial/3.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                    </div>
                    <div class="media-body">
                      <h5>mark jecno</h5>
                      <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
    ...
    <!--instagram start-->
    <section class="instagram section-big-py-space">
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="insta-contant2">
              <div class="slide-7 no-arrow">
                <div>
                  <div class="instagram-box">
                    <img src="static/themes/assets/images/insta/1.jpg" class="img-fluid  " alt="insta">
                ...
                <div>
                  <div class="instagram-box">
                    <img src="static/themes/assets/images/insta/3.jpg" class="img-fluid  " alt="insta">
                    <div class="insta-cover">
                      <i class="fa fa-instagram" ></i>
                    </div>
                  </div>
                ...
                <div>
                  <div class="instagram-box">
                    <img src="static/themes/assets/images/insta/5.jpg" class="img-fluid  " alt="insta">
                    <div class="insta-cover">
                      <i class="fa fa-instagram" ></i>
                    </div>
                  </div>
                ...
                <div>
                  <div class="instagram-box">
                    <img src="static/themes/assets/images/insta/7.jpg" class="img-fluid  " alt="insta">
                    <div class="insta-cover">
                      <i class="fa fa-instagram" ></i>
                    </div>
                  </div>
                ...
                <div>
                  <div class="instagram-box">
                    <img src="static/themes/assets/images/insta/9.jpg" class="img-fluid  " alt="insta">
                    <div class="insta-cover">
                      <i class="fa fa-instagram" ></i>
                    </div>
                  </div>
                ...
                <div>
                  <div class="instagram-box">
                    <img src="static/themes/assets/images/insta/11.jpg" class="img-fluid  " alt="insta">
                    <div class="insta-cover">
                      <i class="fa fa-instagram" ></i>
                    </div>
                  </div>
                ...
                <div>
                  <div class="instagram-box">
                    <img src="static/themes/assets/images/insta/13.jpg" class="img-fluid  " alt="insta">
                    <div class="insta-cover">
                      <i class="fa fa-instagram" ></i>
                    </div>
                  </div>
                ...
                <div>
                  <div class="instagram-box">
                    <img src="static/themes/assets/images/insta/2.jpg" class="img-fluid  " alt="insta">
                    <div class="insta-cover">
                      <i class="fa fa-instagram" ></i>
                    </div>
                  </div>
...
export default {
  ...
  methods:{
    ...mapActions([
      ...
      let myHostAddress=this.host;
  		var self = this;

      // new code for cache axios
      api({
        url: myHostAddress+'items/Food',
        method: 'get'
      }).then(async (response) => {
      ...
      // new code for cache axios
      // if(mCache.get( "items_Food")){
      //   console.log( 'cache: ',mCache.get( "items_Food") );
      //   self.items = mCache.get( "items_Food");
      // }else{
      //   axios.get(myHostAddress+'items/Food')
      //       .then(response=>{

      //         mCache.put( "items_Food", response.data, 600, function( success ){
      //           if(success ){
      ...
      // myCache.get( "items_Food", function( err, value ){
      //   console.log('err: ',err);
      ...
      //         //myCache.set( "items/Food", response.data, 2*60*60 );// 2 min

      //         myCache.set( "items_Food", response.data, function( err, success ){
      //           if( !err && success ){
      //             console.log( success );
      //             // true
      //             // ... do something ...
    ...
    getHomeHotdeals(){
  		var self = this
  		axios.get(this.host+'home/hotdeals')
  		.then(response=>{
        if(response.data.length){
            self.hotdeals = response.data
        }else{
            self.hotdeals = []
        }
  		})
  ...
  mounted(){
    console.log('nayeem ',this.host)
  	this.getFood()
    this.getHomeHotdeals()
    this.getHomeSpecials()
    this.topRated()
    this.offerPage()
    this.setHead({
      title: "Home | grocery",
